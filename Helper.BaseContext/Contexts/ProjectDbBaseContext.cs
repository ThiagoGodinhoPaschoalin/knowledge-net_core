...
{
    public sealed class ProjectDbBaseContext : DbContext
    {
        public ProjectDbBaseContext(DbContextOptions<ProjectDbBaseContext> options) 
            : base(options)
        { }

        public DbSet<ProductModel> BaseProducts { get; set; }
        public DbSet<StarRatingModel> BaseStarRatings { get; set; }
